...
function Preview() {
  return (
    ...
    <div> 
    <div>
      <img class="flex  left-48 bottom-391 absolute" src={stream1} alt="" style={{ width: '700px', height: '430px' }}></img></div>
    ...
    <div class="left-1093 flex bottom-391 absolute"><img  src={stream1} alt="" style={{ width: '700px', height: '430px' }}></img>
    </div>
    </div>
